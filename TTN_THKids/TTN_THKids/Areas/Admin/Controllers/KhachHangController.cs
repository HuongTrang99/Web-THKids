...
namespace TTN_THKids.Areas.Admin.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKhachHang,HoTen,Email,DiaChi,SoDienThoai,TenDangNhap,MatKhau,NgaySinh,GioiTinh,ThoiGianDangKy")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
